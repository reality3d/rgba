...
// RET: NULL  - Error
//      image - OK
GLT_API image_t IMG_New (int width, int height, int bpp);


// RET: NULL  - Error
//      image - OK
GLT_API image_t IMG_Read (char *filename);


// RET: 0 - Error
//      1 - OK
GLT_API int IMG_Delete (image_t img);
...
GLT_API int IMG_Convert (image_t img, int dst_bits_per_pixel);


// RET: Last error string
GLT_API char *IMG_GetError (void);
...
GLT_API void IMG_SetIO (IO_Open open, IO_Read read, IO_Close close);
...
///////////////////////////////////////////////////////////////////////
GLT_API int   IMG_GetWidth  (image_t img);  // Width in pixels
GLT_API int   IMG_GetHeight (image_t img);  // Height in pixels
GLT_API int   IMG_GetBPP    (image_t img);  // Bits per pixel
GLT_API void *IMG_GetData   (image_t img);  // Pointer to data
GLT_API int   IMG_GetSize   (image_t img);  // Image size in bytes
