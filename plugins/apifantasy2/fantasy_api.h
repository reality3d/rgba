...
EPOPEIA_PLUGIN_API extern PFNGLBINDBUFFERARBPROC		 f_glBindBufferARB;
EPOPEIA_PLUGIN_API extern PFNGLDELETEBUFFERSARBPROC         f_glDeleteBuffersARB;
EPOPEIA_PLUGIN_API extern PFNGLGENBUFFERSARBPROC            f_glGenBuffersARB;
EPOPEIA_PLUGIN_API extern PFNGLBUFFERDATAARBPROC            f_glBufferDataARB;
EPOPEIA_PLUGIN_API extern PFNGLMAPBUFFERARBPROC             f_glMapBufferARB;
EPOPEIA_PLUGIN_API extern PFNGLUNMAPBUFFERARBPROC           f_glUnmapBufferARB;
