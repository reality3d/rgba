...
#define BLEND_SUB	7 // Blend substractivo, depende de la extensión EXT_blend_substract
#define BLEND_MASK2	8 // Multitexturing, requiere de la extensión TEXTURE_ENV_COMBINE (experimental)
